...
export default async function FinancialsPage() {
  ...
  const [
    ...
    safeQuery<KPIAggregates>('fetchKPIAggregates', () => fetchKPIAggregates(supabase), emptyAggregates),
    safeQuery<PnLInput>('fetchPnLData', () => fetchPnLData(supabase), emptyPnLInput),
    safeQuery<ProfitByTruck[]>('fetchProfitByTruck', () => fetchProfitByTruck(supabase), []),
    safeQuery<ProfitByDriver[]>('fetchProfitByDriver', () => fetchProfitByDriver(supabase), []),
