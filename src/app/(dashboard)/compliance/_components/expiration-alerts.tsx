...
export function ExpirationAlerts() {
  ...
  return (
    <div className="space-y-3">
      {expired.length > 0 && (
        <div className="flex items-center gap-3 rounded-lg border px-4 py-3 text-sm text-red-800">
      ...
      {expiringSoon.length > 0 && (
        <div className="flex items-center gap-3 rounded-lg border px-4 py-3 text-sm text-amber-800">
