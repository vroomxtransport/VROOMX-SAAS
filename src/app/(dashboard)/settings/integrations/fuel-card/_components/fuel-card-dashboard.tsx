...
function SyncStatusBadge({ status }: { status: FuelCardStatusData['syncStatus'] }) {
  ...
  if (status === 'syncing') {
    return (
      <Badge className="gap-1 bg-sky-100 text-sky-700 border-sky-200">
...
function MatchBadge({ row }: { row: FuelCardTransactionRow }) {
  if (row.flagged) {
    return (
      <Badge className="gap-1 bg-rose-100 text-rose-700 border-rose-200 text-[11px]">
  ...
  if (row.matchedTruckId) {
    return (
      <Badge className="gap-1 bg-emerald-100 text-emerald-700 border-emerald-200 text-[11px]">
  ...
  return (
    <Badge className="gap-1 bg-amber-100 text-amber-700 border-amber-200 text-[11px]">
    ...
    <div className="space-y-4">
      ...
      <div className="widget-card">
        ...
        {txQuery.isLoading ? (
          ...
          <div className="flex items-center gap-2 rounded-lg border border-rose-200 bg-rose-50 px-3 py-4 text-sm text-rose-700">
