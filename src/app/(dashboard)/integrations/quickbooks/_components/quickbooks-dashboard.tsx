...
function SyncHistoryRow({ event }: SyncHistoryRowProps) {
  ...
  const statusConfig = {
    success: { icon: <Check className="h-3.5 w-3.5" />, className: 'text-emerald-600 bg-emerald-50 border-emerald-200' },
    error: { icon: <X className="h-3.5 w-3.5" />, className: 'text-red-600 bg-red-50 border-red-200' },
    partial: { icon: <AlertCircle className="h-3.5 w-3.5" />, className: 'text-amber-600 bg-amber-50 border-amber-200' },
  }
