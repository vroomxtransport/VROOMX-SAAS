...
const RANK_STYLES = [
  ...
  { badge: 'bg-gradient-to-br from-slate-300 to-slate-500 text-white shadow-sm', avatar: 'text-violet-700', bar: 'bg-gradient-to-r from-violet-500 to-violet-400' },
  { badge: 'bg-gradient-to-br from-amber-600 to-amber-800 text-white shadow-sm', avatar: 'text-blue-700', bar: 'bg-gradient-to-r from-blue-500 to-blue-400' },
]
