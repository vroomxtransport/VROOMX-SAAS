...
/**
 * Resume application page — applicant enters email, receives magic link.
 *
...
export default function ResumePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12" style={{ backgroundColor: '#0C1220' }}>
        ...
        <div className="rounded-xl bg-white px-8 py-10 shadow-2xl">
          {!submitted ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 outline-none transition-colors focus:border-[#192334] focus:ring-1 focus:ring-[#192334] placeholder:text-gray-400"
                  />
                  {error && (
                    <p
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="w-full rounded-lg bg-[#192334] px-6 py-3 text-sm font-semibold text-white hover:bg-[#2a3a4f] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#192334] focus-visible:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="space-y-4 text-center">
              ...
              <Link
                href={`/apply/${tenantSlug}`}
                className="mt-2 inline-block text-xs text-[#192334] underline hover:text-[#fb7232] transition-colors"
              >
