...
export const metadata: Metadata = {
  title: 'Auto Transport TMS Pricing — Plans from $29/mo',
  description:
    'VroomX TMS pricing: Owner-Operator $29/mo (1 truck), Starter X $49/mo (5 trucks), Pro X $149/mo (20 trucks). 14-day free trial on every plan. No credit card required.',
  alternates: {
    canonical: '/pricing',
  },
  openGraph: {
    title: 'Auto Transport TMS Pricing — Plans from $29/mo | VroomX',
    description:
      'VroomX TMS pricing: Owner-Operator $29/mo (1 truck), Starter X $49/mo (5 trucks), Pro X $149/mo (20 trucks). 14-day free trial on every plan.',
    type: 'website',
    siteName: 'VroomX',
  },
  twitter: {
    ...
    title: 'Auto Transport TMS Pricing — Plans from $29/mo | VroomX',
    description:
      'VroomX TMS: Owner-Operator $29/mo, Starter X $49/mo, Pro X $149/mo. 14-day free trial on every plan.',
  },
}
...
const plans: PlanTier[] = [
  ...
  },
  {
    ...
    slug: 'starter_x',
    price: 49,
    description: 'For small fleets taking on their first drivers and building a dispatch workflow.',
    highlighted: true,
    features: [
      'Up to 5 trucks',
