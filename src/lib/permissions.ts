...
export const PERMISSION_CATEGORIES = {
  ...
  terminals: ['terminals.view', 'terminals.create', 'terminals.update', 'terminals.delete'],
  local_drives: ['local_drives.view', 'local_drives.create', 'local_drives.update', 'local_drives.delete'],
  local_runs: ['local_runs.view', 'local_runs.create', 'local_runs.update', 'local_runs.delete'],
  fuel: ['fuel.view', 'fuel.create', 'fuel.update', 'fuel.delete'],
  maintenance: ['maintenance.view', 'maintenance.create', 'maintenance.update', 'maintenance.delete', 'maintenance.close'],
  shops: ['shops.view', 'shops.create', 'shops.update', 'shops.delete'],
...
export const BUILT_IN_ROLES: Record<string, string[]> = {
  ...
  dispatcher: [
    ...
    'brokers.*', 'terminals.*', 'local_drives.*', 'local_runs.*', 'fuel.*', 'maintenance.*', 'shops.*',
