...
- [ ] Create live price IDs for Owner-Operator, Starter X, Pro X plans
- [ ] Update `STRIPE_OWNER_OPERATOR_PRICE_ID`, `STRIPE_STARTER_X_PRICE_ID`, `STRIPE_PRO_X_PRICE_ID` with live IDs
...
STRIPE_OWNER_OPERATOR_PRICE_ID=price_...
STRIPE_STARTER_X_PRICE_ID=price_...
STRIPE_PRO_X_PRICE_ID=price_...
