...
must_haves:
  truths:
    ...
    - "Video capture records vehicle walkthrough video"
...
- Step validation: photos step requires all 7 required photos before allowing next
...
- Option to re-record
- Can skip video step (optional but encouraged)
...
- Video capture uses AVFoundation (not just photo library)
...
- Driver can record a walkthrough video
